...
class TtsDataModule:
    ...
    def train_dataloaders(
        ...
        if True:
            ...
            def drop_c(c):
                ...
                return (len(c.supervisions[0].custom['tokens']['word']) > 0) and (not all(item=="" for item in c.supervisions[0].custom['tokens']['word'])) and (len(c.supervisions[0].custom['tokens']['text'][0]) < 200)
    ...
    def valid_dataloaders(self, cuts_valid: CutSet) -> DataLoader:
        ...
        if True:
            ...
            def drop_c(c):
                # print(c.supervisions[0].custom is not None) and (len(c.supervisions[0].custom['tokens']['char']) < 190)
                # return (len(c.supervisions[0].custom['tokens']['word']) > 0) and (len(c.supervisions[0].custom['tokens']['text']) < 200)
                return (len(c.supervisions[0].custom['tokens']['word']) > 0) and (not all(item=="" for item in c.supervisions[0].custom['tokens']['word'])) and (len(c.supervisions[0].custom['tokens']['text'][0]) < 200)
